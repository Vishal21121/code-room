    ...
    return (
        <div>
            ...
            <form className='flex w-full p-4 justify-center mt-4 gap-4 sticky top-0 bg-[#22272E]'>
                ...
                <input type="submit" value="Create Notes" className="py-2 px-4  rounded-xl text-lg shadow-lg duration-500 outline-none ring-2 ring-solid ring-[#FF6C00] text-white font-medium cursor-pointer hover:shadow-4xl" />
            </form>
